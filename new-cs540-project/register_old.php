...
<head>
    ...
    <title>Registration Successful | BookSmart</title>
...
<main class="main">
    <div class="card">
        ...
        <p>Your account has been created. You can now log in and enjoy our services.</p>
        <a href="login-register.html" class="btn">Go to Login</a>
    </div>
</main>
